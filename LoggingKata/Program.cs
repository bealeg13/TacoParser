...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"{trackable1.Name} and {trackable2.Name} are the furthest distance from each other.");
            Console.WriteLine();
            Console.WriteLine($"The distance between them is {Math.Round(distance/ 1609.344)} miles");
